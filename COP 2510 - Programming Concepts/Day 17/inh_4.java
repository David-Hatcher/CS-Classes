/*	Polymorphism - it lets you treat objects (e.g., 'peter', 'lisa') 
	of different subclasses that are derived from the same superclass 
	as if they had the type of the superclass. So, in the examples
	below, we can use 'somebody' to "represents" peter or lisa.
	
	The print() is defined in all three classes but which print() of
	somebody.print() is actually executed at run time depends on which
	object 'somebody' represents.
*/
...
class inh_4 {
	public static void main(String args[]) {
		...
		**********************************************************************/		
		...
		// undergraduate_student anna = (undergraduate_student)somebody;	// ERROR. Why??												
